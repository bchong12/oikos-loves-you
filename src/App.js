...
function App() {
  return (
    <div className='main'>
      ...
      <iframe className='responsive-iframe' src="https://www.youtube.com/embed/UH1j6egD-PY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="true"></iframe>
      </div>
    </div>
  );
}
